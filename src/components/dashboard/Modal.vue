            ...
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  Send Bulk Mails through Amazon SES ?
                </h3>
                <div class="mt-2">
...
export default {
  ...
  methods: {
    ...
    createbulk(item) {
      if (item === "email") {
        // temporary save a to inidcate this is a bulk email we want to create
        localStorage.setItem("@bulkemail", true);
        this.closemodal();
      } else if (item === "phone") {
        // temporary save a to inidcate this is a bulk phone we want to create
        localStorage.setItem("@bulkphone", true);
        this.closemodal();
      }
      // check current route 
      if (this.$route.name === "Bulk") {
        // if bulk return
        return;
      } else {
        // else take to bulk
